...
class Forward(OceanModelStep):
    ...
    def __init__(
        ...
        self.add_horiz_mesh_input_file(target=f'{init.path}/culled_mesh.nc')
        self.add_vert_coord_input_file(target=f'{init.path}/vert_coord.nc')
        self.add_init_input_file(target=f'{init.path}/init.nc')
        self.add_input_file(
            filename='forcing.nc', target=f'{init.path}/forcing.nc'
        )
        self.add_input_file(
            filename='graph.info', target=f'{init.path}/culled_graph.info'
        )
